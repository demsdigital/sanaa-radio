...
export default async function Footer() {
  ...
  const socials = [
    { key: "social_facebook",  label: "فيسبوك",   icon: (
    ...
    { key: "social_twitter",   label: "تويتر X",   icon: (
    ...
    { key: "social_youtube",   label: "يوتيوب",    icon: (
    ...
    { key: "social_telegram",  label: "تيليغرام",  icon: (
    ...
    { key: "social_instagram", label: "انستغرام",  icon: (
    ...
    { key: "social_tiktok",    label: "تيك توك",   icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              صوت الشرعية اليمنية منذ ١٩٤٧ — نقل الحقيقة وحفظ الهوية الوطنية.
            </p>
            {/* سوشال ميديا */}
            {socials.length > 0 && (
            ...
            <div className="space-y-2.5">
              {[
                ...
                <Link key={link.href} href={link.href}
                  ...
                  <span className="w-1 h-1 rounded-full bg-blue-500 group-hover:bg-blue-400 flex-shrink-0" />
                  {link.label}
                </Link>
              ))}
            </div>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-slate-600">
          ...
          <span className="flex items-center gap-1">
            ...
            Yemen Radio — Broadcasting Since 1947
          </span>
        </div>
      </div>
