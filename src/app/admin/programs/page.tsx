    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-800 text-sm mt-1">{programs.length} برنامج</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-slate-800 text-center py-20">لا توجد برامج بعد</div>
      ) : (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50">
                ...
                <th className="text-right text-slate-800 text-xs font-medium px-6 py-4">التصنيف</th>
              ...
              {programs.map((p) => (
                <tr key={p.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    <div className="text-slate-800 text-xs mt-1">{p.slug}</div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2">
                      <button onClick={() => openEdit(p)} className="text-slate-800 hover:text-slate-900 text-xs px-3 py-1 border border-slate-200 rounded hover:border-slate-400 transition-colors">تعديل</button>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-slate-200 rounded-xl w-full max-w-md p-6 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-slate-800 text-sm mb-2 font-medium">اسم البرنامج</label>
              ...
              <div>
                <label className="block text-slate-800 text-sm mb-2 font-medium">الـ Slug (رابط)</label>
              ...
              <div>
                <label className="block text-slate-800 text-sm mb-2 font-medium">الوصف</label>
              ...
              <div>
                <label className="block text-slate-800 text-sm mb-2 font-medium">التصنيف</label>
              ...
              <div className="flex items-center gap-3">
                ...
                <label htmlFor="active" className="text-slate-800 text-sm">برنامج نشط</label>
              </div>
              <div className="flex gap-3 pt-2">
                ...
                <button type="button" onClick={() => setShowForm(false)} className="flex-1 border border-slate-200 text-slate-800 py-3 rounded-lg text-sm hover:bg-slate-50 transition-colors">
                  إلغاء
                </button>
              </div>
            </form>
