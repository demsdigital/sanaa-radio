    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">{items.length} خبر</p>
        </div>
          ...
          {items.map((item) => (
            <div key={item.id} className="bg-white border border-slate-200 rounded-xl p-5 flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <div className="text-slate-400 text-sm line-clamp-2">{item.body}</div>
                <div className="text-slate-400 text-xs mt-2">{new Date(item.publishedAt).toLocaleDateString("ar-YE")}</div>
              </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-slate-200 rounded-xl w-full max-w-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-slate-500 text-sm mb-2">عنوان الخبر</label>
              ...
              <div>
                <label className="block text-slate-500 text-sm mb-2">نص الخبر</label>
