  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden" dir="rtl">
      ...
      <section className="px-6 pt-24 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 text-blue-600 text-sm uppercase tracking-widest font-bold mb-4 bg-blue-50 px-4 py-2 rounded-full border border-blue-100">من نحن</div>
      ...
      <section className="px-6 py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-blue-600 text-sm uppercase tracking-widest font-bold mb-4 bg-blue-50 px-4 py-2 rounded-full border border-blue-100">التاريخ</div>
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-blue-600 text-sm uppercase tracking-widest font-bold mb-4 bg-blue-50 px-4 py-2 rounded-full border border-blue-100">المحتوى</div>
      ...
      <section className="relative py-24 px-6 overflow-hidden"
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 text-blue-300 text-sm uppercase tracking-widest font-bold mb-4 bg-white/10 px-4 py-2 rounded-full border border-white/20">رسالتنا</div>
      ...
      <section className="px-6 py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 text-blue-600 text-sm uppercase tracking-widest font-bold mb-4 bg-blue-50 px-4 py-2 rounded-full border border-blue-100">بيانات</div>
